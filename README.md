...
- 📁 **01-policy-pipeline/**
  ...
  - [`routing-decisions-without-API-access.txt`](01-policy-pipeline/routing-decisions-without-API-access.txt) —  capture `.venv/bin/pytest tests/test_us04_routing.py -v` instead of the live run.
